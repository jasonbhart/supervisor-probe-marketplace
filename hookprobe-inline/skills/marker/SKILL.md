---
name: marker
description: Inert marker skill for exp-07 (inline variant). Exists only so the plugin is visible in plugin directories; performs no action. Do not invoke.
---

# exp-07 marker (inline)
